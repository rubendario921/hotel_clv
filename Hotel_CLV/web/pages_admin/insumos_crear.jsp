                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form action="Mantenimiento_admin/crudinsumos_crear.jsp" method="POST"onsubmit="return validarFormulario();">
                            <label> Nombre: </label>
                            <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Ingrese el nombre del insumo. " maxlength="50" autocomplete="off" required />
                            <label> Detalle: </label>
                            <input type="text" name="detalle" id="detalle" class="form-control" placeholder="Ingrese el detalle insumo. " maxlength="500" autocomplete="off" required/>
                            <label> Cantidad: </label>
                            <input type="number" name="cantidad" id="cantidad" class="form-control" placeholder="Ingrese la cantidad del insumo. " min="1" maxlength="20" autocomplete="off" required/>
                            <label> Valor: </label>
                            <input type="number" name="valor" id="valor" class="form-control" placeholder="Ingrese el valor del insumo. " step="000.01" autocomplete="off" required/>
                            <label> Estado: </label>
